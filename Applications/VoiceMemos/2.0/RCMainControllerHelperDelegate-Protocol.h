...
@class NSError, NSString, NSUndoManager, RCAVWaveformViewController, RCCaptureSession, RCCompositionController, RCRecordingDisplayModel;
...
- (void)userDidUndeleteRecordingWithUUID:(NSString *)arg1;
