...
@interface IPXGeneralPreferences : NSPreferencesModule
{
    ...
    NSLayoutConstraint *_metadataSectionBottomConstraint;
}

@property __weak NSLayoutConstraint *metadataSectionBottomConstraint; // @synthesize metadataSectionBottomConstraint=_metadataSectionBottomConstraint;
