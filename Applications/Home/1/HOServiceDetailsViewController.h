...
@class HFItem, HMHome, HOAccessorySettingsItemModuleController, HOServiceDetailsItemManager, HOServiceDetailsTextViewDelegate, HUChildServiceItemModuleController, HUControlPanelController, HUSoftwareUpdateItemModuleController, HUTelevisionSettingsItemModuleController, NSHashTable, NSString, UILongPressGestureRecognizer;
