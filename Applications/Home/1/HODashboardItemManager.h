...
@class HFActionSetListItem, HFBridgeItemProvider, HFCameraItemProvider, HFDemoModeAccessoryItemProvider, HFGenericAccessoryItemProvider, HFItem, HFMediaAccessoryItemProvider, HFProgrammableSwitchItemProvider, HFReorderableHomeKitItemList, HFServiceGroupItemProvider, HFServiceItemProvider, HFTargetControlItemProvider, HMRoom;
