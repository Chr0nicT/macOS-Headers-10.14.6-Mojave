...
@class HFAccessoryInfoDetailsItemProvider, HFAssociatedServiceTypeOptionItemProvider, HFItem, HFItemBuilder, HFItemProvider, HFRemoteControlItemModule, HFSelectedRoomItemProvider, HFStaticItemProvider, HMAccessory, HOAccessoryDebugModule, HOAccessorySettingsItemModule, HOServiceDetailsControlAndCharacteristicStateItemModule, HOServiceDetailsProgrammableSwitchItemModule, HUFirmwareUpdateItemProvider, HUInputSourceItemModule, HULinkedApplicationItemProvider, HUSoftwareUpdateItemModule, HUTelevisionSettingsItemModule, HUValveItemModule, NSArray, NSSet, NSString;
