...
@interface UnifiedChatWindowController : ChatWindowController <NSUserNotificationCenterDelegate, NSMenuDelegate, IMSystemMonitorListener>
{
    ...
    NSString *_userNotificationChatGUID;
...
+ (void)preloadForPerformance;
+ (id)sharedController;
+ (id)allowedChatDisplayControllerSecuredArchiveClasses;
...
@property(copy, nonatomic) NSString *userNotificationChatGUID; // @synthesize userNotificationChatGUID=_userNotificationChatGUID;
...
- (void)hideNoMessageSelectedPlacard:(BOOL)arg1;
...
- (void)reloadAfterDaemonReconnected:(id)arg1;
- (void)windowDidLoad;
- (void)dealloc;
- (id)init;
- (void)_setupZeroChatViewMode;
- (void)_setChatDisplayCompletionBlock:(CDUnknownBlockType)arg1 forChatDisplayController:(id)arg2;
- (void)addAndDisplayChatDisplayControllerForNewChatWithHandles:(id)arg1 bizIntent:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
...
- (void)finalizeWindowInitialization;
- (void)restoreUnifiedChatWindowContents;
- (void)addEmptyChatIfNeeded;
- (void)_finishRestore;
- (void)restoreSelection;
- (void)restoreChatsFromChatRegistryWithChangeHistory:(id)arg1;
- (void)_restoreChats;
