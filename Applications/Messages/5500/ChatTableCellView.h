...
@class CNAvatarViewController, IMTypingChatItem, MaskedView, NSArray, NSButton, NSImageView, NSLayoutConstraint, NSString, NSTextField, NSTimer, NSTrackingArea, NSView, SOChatDisplayController, SOFaceTimeCallHandler, SOStaticImageView, SOTypingIndicatorView;

@interface ChatTableCellView : NSTableCellView <CNAvatarViewDelegate, NSImmediateActionGestureRecognizerDelegate, NSMenuDelegate, SOFaceTimeCallHandlerDelegate>
{
...
- (void)_updateSummary;
- (id)_actualChatSummary;
- (id)_formattedSummaryContent:(id)arg1;
- (void)_clearSummaryValues;
- (id)_legacySummaryString;
- (id)_searchStringSummary;
- (id)_formattedSummaryContentWithFaceTimeCallInfo:(id)arg1;
