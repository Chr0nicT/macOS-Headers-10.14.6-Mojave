...
#import "SOOrderedSetControllerDelegate-Protocol.h"

@class ChatTranscriptSearch, IMHeaderView, NSArray, NSButton, NSLayoutConstraint, NSMutableSet, NSPopover, NSProgressIndicator, NSSearchField, NSSegmentedControl, NSString, NSTableView, NSView, SOChatDisplayController, SOOrderedSetController, SyncProgressViewController;

@interface UnifiedChatListViewController : NSViewController <NSPopoverDelegate, NSTableViewDelegate, NSTableViewDataSource, SOOrderedSetControllerDelegate, NSSearchFieldDelegate>
{
    BOOL _disableTableViewAnimations;
    ...
    NSView *_senderFilteringHeader;
    NSSegmentedControl *_senderFilteringHeaderTabSegments;
    NSTableView *_chatTable;
    SOOrderedSetController *_contentsController;
    ...
    SyncProgressViewController *_syncProgressViewController;
}
...
+ (id)emptyChatContentsFilterUpdateNotifications;
+ (id)searchResultsContentsFilterUpdateNotifications;
+ (CDUnknownBlockType)emptyChatContentsFilter;
+ (CDUnknownBlockType)searchResultsContentsFilter;
+ (id)sharedController;
+ (BOOL)isPinnedConversationsEnabled;
@property(retain, nonatomic) SyncProgressViewController *syncProgressViewController; // @synthesize syncProgressViewController=_syncProgressViewController;
...
@property(readonly, nonatomic) SOOrderedSetController *contentsController; // @synthesize contentsController=_contentsController;
...
@property __weak NSSegmentedControl *senderFilteringHeaderTabSegments; // @synthesize senderFilteringHeaderTabSegments=_senderFilteringHeaderTabSegments;
@property __weak NSView *senderFilteringHeader; // @synthesize senderFilteringHeader=_senderFilteringHeader;
...
- (void).cxx_destruct;
- (void)scrollSelectedChatIntoDisplayRect;
- (void)selectVisibleChatWithGUID:(id)arg1;
@property(retain, nonatomic) SOChatDisplayController *selectedChatDisplayController; // @dynamic selectedChatDisplayController;
@property(nonatomic) unsigned long long selectedChatDisplayControllerIndex; // @dynamic selectedChatDisplayControllerIndex;
- (unsigned long long)indexOfVisibleChatDisplayController:(id)arg1;
- (id)visibleChatDisplayControllerAtIndex:(unsigned long long)arg1;
@property(readonly, nonatomic) unsigned long long chatCount;
@property(readonly, nonatomic) BOOL hasChats;
@property(readonly, nonatomic) unsigned long long visibleChatCount;
@property(readonly, nonatomic) BOOL hasVisibleChats;
...
@property BOOL showsSearchSpinner;
...
- (id)addExistingChatDisplayControllerForChat:(id)arg1;
- (id)_existingChatForInsertionForChat:(id)arg1;
- (id)existingChatDisplayControllerForChat:(id)arg1;
- (_Bool)_shouldFilterEmptyChats:(id)arg1;
...
- (void)finishLaunchRestoration;
- (void)restoreDelegatesIfNeeded;
- (void)_syncTableSelectionWithContentsController;
- (void)restoreChatsWithChangeHistory:(id)arg1;
- (void)restoreChats;
- (void)beginLaunchRestoration;
