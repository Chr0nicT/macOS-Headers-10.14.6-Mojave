...
@class NSButton, NSLayoutConstraint, NSMutableSet, NSProgressIndicator, NSString, NSTableView, NSTextField, NSTimer, NSView, SOStaticImageView, SOWebLinkButton;
...
@interface AliasSelectionViewController : NSViewController <NSTextFieldDelegate>
{
    ...
    NSTextField *_verifyInitialAliasHelpTextField;
    NSTextField *_appleIDField;
    NSButton *_readReceiptsCheckbox;
    NSView *_topDividerLine;
    NSView *_bottomDividerLine;
...
@property(retain) NSView *bottomDividerLine; // @synthesize bottomDividerLine=_bottomDividerLine;
@property(retain) NSView *topDividerLine; // @synthesize topDividerLine=_topDividerLine;
...
@property(retain) NSTextField *verifyInitialAliasHelpTextField; // @synthesize verifyInitialAliasHelpTextField=_verifyInitialAliasHelpTextField;
