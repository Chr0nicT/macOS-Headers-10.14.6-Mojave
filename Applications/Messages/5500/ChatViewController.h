...
@class IMChat, NSArray, NSButton, NSLayoutConstraint, NSOrderedSet, NSStackView, NSString, NSTextField, NSView, NSVisualEffectView, NSWindow, SOBusinessInfoViewController, SOChatDisplayController, SOInputLine, SOInputLineViewController, SORecipientBarViewController, SOTranscriptViewController;
...
@interface ChatViewController : NSViewController <SOInputLineViewControllerDelegate, IMChatSendProgressDelegate>
{
    ...
    SOBusinessInfoViewController *_businessInfoViewController;
    ...
    NSStackView *_footerViewContent;
...
@property(retain) NSStackView *footerViewContent; // @synthesize footerViewContent=_footerViewContent;
...
@property(retain, nonatomic) SOBusinessInfoViewController *businessInfoViewController; // @synthesize businessInfoViewController=_businessInfoViewController;
...
- (void)viewDidAppear;
- (void)_updateBusinessInfoView;
- (void)_hideBusinessInfoView;
- (void)_showBusinessInfoView;
- (void)_configureBusinessInfoViewWithChatDisplayController:(id)arg1;
...
- (void)_shouldShowInputInterface;
...
- (void)inputLineDidEnter:(id)arg1 isAudioMessage:(BOOL)arg2 expressiveSendStyleID:(id)arg3;
- (BOOL)addNewIMHandles:(id)arg1;
- (void)_updateFooterContents:(id)arg1;
- (void)_accountLoginStatusChanged:(id)arg1;
@property(readonly, getter=isInputLineVisible) BOOL inputLineVisible;
- (BOOL)canSendContent;
...
- (void)_updateViewsForAppearance;
- (void)viewDidLoad;
- (void)_beginNewChat;
@property(readonly) BOOL shouldShowFooter;
