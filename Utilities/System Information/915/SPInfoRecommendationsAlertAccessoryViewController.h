...
@interface SPInfoRecommendationsAlertAccessoryViewController : SPInfoViewController <NSTableViewDelegate>
{
    ...
    NSTableCellView *_prototypeStandardTableCellView;
    NSTableCellView *_prototypeAnnotatedTableCellView;
    NSIndexSet *_selectionIndexes;
}

@property(copy) NSIndexSet *selectionIndexes; // @synthesize selectionIndexes=_selectionIndexes;
@property(retain) NSTableCellView *prototypeAnnotatedTableCellView; // @synthesize prototypeAnnotatedTableCellView=_prototypeAnnotatedTableCellView;
@property(retain) NSTableCellView *prototypeStandardTableCellView; // @synthesize prototypeStandardTableCellView=_prototypeStandardTableCellView;
...
- (BOOL)recommendationHasSecondaryMessage:(id)arg1;
