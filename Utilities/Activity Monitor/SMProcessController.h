...
@interface SMProcessController : NSObject <NSToolbarDelegate, NSOutlineViewDataSource, NSOutlineViewDelegate, NSTouchBarProvider, NSTouchBarDelegate, AssetCacheServicesManagerEventsProtocol>
{
    ...
    SMCacheController *_cacheTabController;
...
@property(retain) SMCacheController *cacheTabController; // @synthesize cacheTabController=_cacheTabController;
