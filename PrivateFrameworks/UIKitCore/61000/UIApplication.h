...
+ (void)_emitMacApplicationLaunchExtendedEndSignposts;
+ (void)_emitMacApplicationLaunchEndSignpostsOptedIntoExtended:(BOOL)arg1;
+ (void)_emitMacApplicationLaunchBeginSignpostsWithOptionalLaunchTime:(double)arg1;
