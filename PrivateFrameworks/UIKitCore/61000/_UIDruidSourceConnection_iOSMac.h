...
@class NSArray, NSObject, NSString, UHADragOperationMasks;
@protocol OS_dispatch_group, UHADragOperationMasksInterface, UHADragSessionInterface;

__attribute__((visibility("hidden")))
@interface _UIDruidSourceConnection_iOSMac : UHASRemoteObject <_UIDruidSourceConnection, UHADragSessionHandlerInterface>
{
