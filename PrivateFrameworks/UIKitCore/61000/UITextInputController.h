...
@interface UITextInputController : NSObject <UITextInput_Internal, _UITextInputServicesMenuDataProviding, UITextInput, UITextInputAdditions, UIResponderStandardEditActions>
{
...
- (id)_objectsForCurrentSelection;
