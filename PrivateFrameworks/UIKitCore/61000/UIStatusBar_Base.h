...
@interface UIStatusBar_Base : _UIScrollsToTopInitiatorView <UIStatusBarServerClient>
{
    ...
    CDStruct_0ea7c6fe *_localDataOverrides;
...
@property(readonly, nonatomic) CDStruct_0ea7c6fe *localDataOverrides; // @synthesize localDataOverrides=_localDataOverrides;
...
- (void)setLocalDataOverrides:(CDStruct_0ea7c6fe *)arg1;
