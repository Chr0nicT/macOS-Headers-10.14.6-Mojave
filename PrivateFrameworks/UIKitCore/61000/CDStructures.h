...
struct StdFBShmem_t {
    ...
    char _field5;
    char _field6;
    struct IOGBounds _field7;
    struct IOGBounds _field8;
    struct IOGPoint _field9;
    struct IOGBounds _field10;
    struct IOGBounds _field11;
    struct IOGBounds _field12;
    int _field13;
    int _field14;
    struct UnsignedWide _field15;
    struct UnsignedWide _field16;
    unsigned long long _field17;
    unsigned int _field18[27];
    unsigned char _field19[4];
    unsigned char _field20;
    unsigned char _field21;
    unsigned char _field22;
    unsigned char _field23[1];
    struct IOGSize _field24[4];
    struct IOGPoint _field25[4];
    union {
        struct bm12Cursor _field1;
        struct bm18Cursor _field2;
        struct bm34Cursor _field3;
        struct bm38Cursor _field4;
    } _field26;
};
...
struct bm12Cursor {
    unsigned int _field1[4][16];
    unsigned int _field2[4][16];
    unsigned int _field3[16];
};

struct bm18Cursor {
    unsigned char _field1[4][256];
    unsigned char _field2[4][256];
    unsigned char _field3[256];
};

struct bm34Cursor {
    unsigned short _field1[4][256];
    unsigned short _field2[256];
};

struct bm38Cursor {
    unsigned int _field1[4][256];
