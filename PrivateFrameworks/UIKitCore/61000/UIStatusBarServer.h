...
+ (CDStruct_0ea7c6fe *)getStatusBarOverrideData;
+ (const CDStruct_65a685f2 *)getStatusBarData;
+ (void)permanentizeStatusBarOverrideData;
+ (void)postStatusBarOverrideData:(CDStruct_0ea7c6fe *)arg1;
...
+ (void)postStatusBarData:(const CDStruct_65a685f2 *)arg1 withActions:(int)arg2;
...
- (void)_receivedStatusBarData:(CDStruct_65a685f2 *)arg1 actions:(int)arg2 animated:(BOOL)arg3;
