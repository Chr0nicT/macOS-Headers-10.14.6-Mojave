...
@class AVAudioEngine, AVURLAsset, NSDate, NSError, NSMutableOrderedSet, NSString, RCAVState, RCAudioSessionRoutingAssertion, RCCaptureInputDevice, RCCaptureInputWaveformDataSource, RCSSavedRecordingService;
