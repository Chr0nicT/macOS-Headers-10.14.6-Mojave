...
struct HTMLVideoElement {
    ...
    struct Optional<WTF::Variant<WTF::RefPtr<WebCore::Blob, WTF::DumbPtrTraits<WebCore::Blob>>>> _field112;
    ...
    _Bool _field122;
    _Bool _field123;
    struct unique_ptr<WebCore::HTMLImageLoader, std::__1::default_delete<WebCore::HTMLImageLoader>> _field124;
    struct AtomicString _field125;
